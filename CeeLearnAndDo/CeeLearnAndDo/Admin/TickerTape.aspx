    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header" data-background-color="purple">
                <h4 class="title">Producten toevoegen</h4>
                <p class="category">Add surboardss</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" id="ModelId" runat="server" class="form-control">
                        </div>
                          <div class="form-group label-floating">
                            <label class="control-label">Beschijving</label>
                            <input type="text" id="BeschijvingId" runat="server" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group label-floating">
                            <label class="control-label">Verkooprijs</label>
                            <input type="text" runat="server" id="VerkoopprijsId" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">Afbeelding URL</label>
                            <input type="text" runat="server" id="Afbeelding_URLId" class="form-control">
                        </div>
                    </div>
