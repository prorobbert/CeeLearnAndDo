...
<asp:Content ID="Content4" ContentPlaceHolderID="GridviewFAQPlaceholder" runat="server">
    ...
    <asp:GridView
        ...
        OnSelectedIndexChanging="GridViewProducts_SelectedIndexChanging"
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group label-floating">
                            ...
                            <textarea class="form-control" id="Description" cols="20" rows="4" runat="server"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <asp:Button ID="Button1" Enabled="false" runat="server" OnClick="InputBoxButton_Clicked" class="btn btn-primary pull-right" Text="Send" />
